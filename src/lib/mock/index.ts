...
export const mockFinancialAgreements: FinancialAgreement[] = [
    { id: 1, direction: "recette", project_id: 1, partner_id: 2, axis_id: 1, status_id: 16, title: "Convention Entreprise A", description: "Accord de co-financement formation", budget: 45000, grant: 30000, signed_date: "2024-03-01", budget_detail_id: 11 },
    { id: 2, direction: "depense", project_id: 2, partner_id: 3, axis_id: 2, status_id: 15, title: "Convention Association B", description: "Accord de partenariat recherche", budget: 60000, grant: 50000, signed_date: "2024-06-15", budget_detail_id: 15 },
    { id: 3, direction: "depense", project_id: 3, partner_id: 4, axis_id: 3, status_id: 15, title: "Convention Institut Recherche", description: "Accord de cooperation internationale", budget: 30000, grant: 25000, signed_date: "2025-02-01", budget_detail_id: 15 },
    { id: 4, direction: "recette", project_id: 4, partner_id: 6, axis_id: null, status_id: 14, title: "Convention Fondation E", description: "Subvention innovation et transfert", budget: 80000, grant: 70000, signed_date: "2025-07-01", budget_detail_id: 9 },
    { id: 5, direction: "recette", project_id: 2, partner_id: 5, axis_id: 2, status_id: 15, title: "Convention Collectivite D", description: "Cofinancement recherche territoriale", budget: 20000, grant: 15000, signed_date: "2025-03-15", budget_detail_id: 14 },
    { id: 6, direction: "recette", project_id: 5, partner_id: 1, axis_id: 2, status_id: 15, title: "Convention Universite X - Data", description: "Financement recherche data science territoriale", budget: 50000, grant: 40000, signed_date: "2025-06-01", budget_detail_id: 15 },
    { id: 7, direction: "depense", project_id: 5, partner_id: 5, axis_id: 2, status_id: 15, title: "Convention Collectivite D - Data", description: "Reversement collectivite analyse territoriale", budget: 30000, grant: 20000, signed_date: "2025-07-15", budget_detail_id: null },
    { id: 8, direction: "depense", project_id: 6, partner_id: 3, axis_id: 1, status_id: 14, title: "Convention Association B - Badges", description: "Partenariat certification open badges", budget: 20000, grant: 15000, signed_date: "", budget_detail_id: 11 },
    { id: 9, direction: "recette", project_id: 7, partner_id: 4, axis_id: 2, status_id: 15, title: "Convention Institut - Biodiversite", description: "Financement etude biodiversite urbaine", budget: 35000, grant: 28000, signed_date: "2024-04-01", budget_detail_id: 15 },
    { id: 10, direction: "depense", project_id: 7, partner_id: 5, axis_id: 2, status_id: 15, title: "Convention Collectivite D - Bio", description: "Reversement collectivite cartographie", budget: 22000, grant: 18000, signed_date: "2024-05-01", budget_detail_id: null },
    { id: 11, direction: "depense", project_id: 8, partner_id: 4, axis_id: 3, status_id: 14, title: "Convention Institut - Cooperation Sud", description: "Convention cooperation internationale non signee", budget: 30000, grant: 22000, signed_date: "", budget_detail_id: 15 },
    { id: 12, direction: "depense", project_id: 10, partner_id: 2, axis_id: 4, status_id: 15, title: "Convention Entreprise A - Smart Campus", description: "Partenariat deploiement IoT campus", budget: 60000, grant: 45000, signed_date: "2024-10-01", budget_detail_id: 13 },
    { id: 13, direction: "recette", project_id: 12, partner_id: 1, axis_id: 3, status_id: 15, title: "Convention Universite X - HorizonX", description: "Subvention Horizon Europe", budget: 200000, grant: 180000, signed_date: "2025-09-15", budget_detail_id: 9 },
    { id: 14, direction: "depense", project_id: 12, partner_id: 6, axis_id: 3, status_id: 14, title: "Convention Fondation E - HorizonX", description: "Reversement fondation non finalise", budget: 80000, grant: 60000, signed_date: "", budget_detail_id: null },
]
...
export const mockToDoItems: ToDoItem[] = [
    { id: 1, list_id: 1, content: 'Réserver la salle', status_id: 9, start_date: '2025-08-01', end_time: '2025-08-15', due_date: '2025-08-10', owner_id: null },
    { id: 2, list_id: 1, content: 'Envoyer les invitations', status_id: 9, start_date: '2025-08-15', end_time: '2025-08-30', due_date: '2025-08-25', owner_id: null },
    { id: 3, list_id: 2, content: 'Collecter les indicateurs', status_id: 9, start_date: '2025-06-01', end_time: '2025-06-15', due_date: '', owner_id: null },
    { id: 4, list_id: 2, content: 'Rédiger la synthèse', status_id: 9, start_date: '2025-06-15', end_time: '2025-06-25', due_date: '', owner_id: null },
    { id: 5, list_id: 3, content: 'Préparer les supports', status_id: 8, start_date: '2026-04-25', end_time: '2026-05-01', due_date: '2026-04-30', owner_id: null },
    { id: 6, list_id: 3, content: 'Inviter les participants', status_id: 8, start_date: '2026-04-28', end_time: '2026-05-05', due_date: '', owner_id: null },
    { id: 7, list_id: 4, content: 'Envoyer l\'ordre du jour', status_id: 8, start_date: '2026-05-28', end_time: '2026-06-01', due_date: '2026-05-30', owner_id: null },
    { id: 8, list_id: 4, content: 'Préparer les indicateurs', status_id: 8, start_date: '2026-05-28', end_time: '2026-06-04', due_date: '', owner_id: null },
]
